...
function kalite_filo_send_customer_confirmation(
    ...
    $html = '<!doctype html><html lang="' . $locale . '"><body style="margin:0;padding:0;background:#f2f4f7;font-family:Arial,Helvetica,sans-serif;color:#182136">'
        ...
        . '<tr><td style="padding:24px;background:#182136;text-align:center"><a href="' . $homeUrl . '" style="display:inline-block;text-decoration:none"><img alt="Kalite Filo" src="cid:kf-brand-logo" style="display:block;width:210px;max-width:100%;height:auto;margin:0 auto"></a></td></tr>'
