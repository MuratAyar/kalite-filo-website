...
try {
    ...
    if(($_SERVER['REQUEST_METHOD']??'')==='GET')kalite_filo_admin_json(['selection'=>kalite_filo_admin_featured_articles_selection(is_array($published)?$published:[]),'articles'=>array_values($byId),'categories'=>KALITE_FILO_ARTICLE_CATEGORIES]);
