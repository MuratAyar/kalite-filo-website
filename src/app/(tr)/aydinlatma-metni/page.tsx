...
export default function FormPrivacyNoticePage() {
  return (
    <main className="max-w-full flex-1 overflow-x-clip bg-white text-black" id="main-content" tabIndex={-1}>
