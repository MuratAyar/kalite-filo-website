...
test("release assembly includes the complete Composer mail runtime and no private config", () => {
  ...
  for (const relativePath of [
    ...
    "admin-api/vehicle-image.php",
    "admin-api/article-media-store.php",
    "admin-api/article-cover.php",
    "admin-api/image-file.php",
    "admin-api/taxonomy-store.php",
    "admin-api/tags.php",
    "admin-api/featured-vehicles.php",
    "admin-api/featured-article-store.php",
    "admin-api/featured-articles.php",
